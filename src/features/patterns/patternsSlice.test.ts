...
describe("patternsSlice", () => {
  describe("loadPatterns action", () => {
    it("should load all patterns from data files", () => {
      ...
      // Should have loaded 165 patterns
      const state = store.getState().patterns;
      expect(Object.keys(state.patterns)).toHaveLength(165);
    ...
    it("should normalize patterns by ID", () => {
      ...
      const circuitBreaker =
        store.getState().patterns.patterns["circuit-breaker"];
  ...
  describe("selectors", () => {
    ...
    it("selectPatternById should return specific pattern", () => {
      ...
      const pattern = selectPatternById(
  ...
  describe("generateCards action", () => {
    it("should generate 80 cards from 16 patterns", () => {
      const store = createTestStore();
      ...
      // Should have generated 825 cards (165 patterns × 5 cards each)
      const state = store.getState().patterns;
      expect(Object.keys(state.cards)).toHaveLength(825);
  ...
  describe("card selectors", () => {
    ...
    it("selectCardsByPattern should return all cards for a pattern", () => {
      ...
      const cards = selectCardsByPattern(
        store.getState() as RootState,
        "circuit-breaker",
      );
